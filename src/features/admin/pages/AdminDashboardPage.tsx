...
export function AdminDashboardPage() {
  ...
  useEffect(() => {
    ...
    async function loadDashboard() {
      try {
        ...
        if (hasTotalFailure) {
          setLoadError("No fue posible cargar el dashboard administrativo.");
        }
      } finally {
        if (isMounted) {
          setIsLoading(false);
  ...
  if (isLoading) {
    return <Loader label="Cargando dashboard administrativo..." />;
  }
  ...
  return (
    <section>
      <PageHeader
        ...
        description="Control general de usuarios, editoras, emprendedoras, productos, categorías y aprobaciones de REDMUEMMA."
        actions={
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-[0.8fr_1.2fr]">
        ...
        <Card>
          <h2 className="text-lg font-bold text-ink-900">Accesos rápidos</h2>

          <div className="mt-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <QuickActionCard
              title="Usuarios"
              description="Gestionar administradores y editoras."
              href={paths.admin.users}
              icon={Users}
            />
            ...
            <QuickActionCard
              title="Emprendedoras"
              description="Revisar perfiles, contacto y redes."
              href={paths.admin.entrepreneurs}
              icon={UserRoundCheck}
            />
            ...
            <QuickActionCard
              title="Productos"
              description="Crear, editar y aprobar productos."
              href={paths.admin.products}
              icon={Package}
            />
            ...
            <QuickActionCard
              title="Categorías"
              description="Clasificar productos y emprendedoras."
              href={paths.admin.categories}
              icon={Tags}
            />
          </div>
          ...
          <div className="mb-5 flex items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-ink-500">
                Últimos productos creados en REDMUEMMA.
              </p>
            </div>
        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-ink-500">
              REDMUEMMA centraliza la comercialización en la plataforma. Los
              productos se asocian directamente a una emprendedora; el equipo
              admin/editor gestiona categorías, imágenes, estados y
              aprobaciones.
            </p>
          </div>
